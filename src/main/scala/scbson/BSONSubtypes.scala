...
object BSONSubtypes {
	...
	val bsonNull		= Subtype.partial[BSONValue,BSONNull.type]		{ case BSONNull					=> BSONNull }
	...
	val bsonMinKey		= Subtype.partial[BSONValue,BSONMinKey.type]	{ case BSONMinKey				=> BSONMinKey }
	val bsonMaxKey		= Subtype.partial[BSONValue,BSONMaxKey.type]	{ case BSONMaxKey				=> BSONMaxKey }
}
